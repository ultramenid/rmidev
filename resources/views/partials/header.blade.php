<header class="bg-black">
    <div x-data="{ open: false }" class="px-3 py-2 bg-black fixed top-0 z-10 sm:hidden block">
        ...
        <div class="fixed w-2/3 h-screen z-50 bg-black  inset-0 overflow-y-auto " x-show="open" @click.outside="open = false" x-cloak style="display: none !important">
