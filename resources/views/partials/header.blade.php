            ...
            x-cloak style="display: none !important">
                ...
                <div class="mt-12 space-y-3">
                    <div class=" text-center px-6">
                        <a href="{{ route('about', app()->getlocale() )}}"  class="mb-4 px-4 inline-block text-base leading-5 text-gray-300 font-semibold uppercase">About<a>
                        <p class="border-b border-gray-300"></p>
                    </div>
                    <div class=" text-center px-6">
                        <a href="{{ route('index', app()->getlocale() )}}"  class="mb-4 px-4 inline-block text-base leading-5 text-gray-300 font-semibold uppercase">Indexing Result<a>
                        <p class="border-b border-gray-300"></p>
                    </div>
                    <div class=" text-center px-6">
                        <a href="{{ route('methodology', app()->getlocale() )}}"  class="mb-4 px-4 inline-block text-base leading-5 text-gray-300 font-semibold uppercase">Methodology<a>
                        <p class="border-b border-gray-300"></p>
                    </div>
                    <div class=" text-center px-6">
                        <a href="{{ route('corporateprofile', app()->getlocale() )}}" class="mb-4 px-4 inline-block text-base leading-5 text-gray-300 font-semibold uppercase">Corporate Profile<a>
                        <p class="border-b border-gray-300"></p>
                    </div>
