    ...
    >
        <div class="max-w-6xl mx-auto px-6 sm:py-16 py-8">
            ...
            <div class="flex flex-col space-y-2">
                <h1 class="uppercase text-center text-gray-300 text-3xl font-bold mb-6">RMI analytical framework</h1>
                {{-- #header --}}
                <div class="flex ">
                 ...
                 <div x-data="{ economicDevelopment : false }">
                    <div class="flex cursor-pointer" @click="economicDevelopment = ! economicDevelopment">
                        ...
                        <div class="flex  border-gray-600  sm:h-12 h-8 sm:w-7/12  w-5/12 items-center justify-center bg-edevelopment2">
                 ...
                 <div x-data="{ lifecycleManagement : false }">
                    <div class="flex cursor-pointer" @click="lifecycleManagement = ! lifecycleManagement">
                        ...
                        <div class="flex  border-gray-600  sm:h-12 h-8 sm:w-7/12  w-5/12 items-center justify-center" style="background-color: #a71681">
                 ...
                 <div x-data="{communityWellbeing : false}">
                    <div class="flex cursor-pointer" @click=" communityWellbeing = ! communityWellbeing">
                        ...
                        <div class="flex  border-gray-600  sm:h-12 h-8 sm:w-7/12  w-5/12 items-center justify-center" style="background-color: #ef7d00">
                ...
                <div x-data="{workingCondition : false}">
                    <div class="flex cursor-pointer" @click="workingCondition = ! workingCondition">
                        ...
                        <div class="flex  border-gray-600  sm:h-12 h-8 sm:w-7/12  w-5/12 items-center justify-center" style="background-color: #e5231b">
