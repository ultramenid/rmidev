...
class OperationAreaComponent extends Component
{
    public $contentenglish, $contentindonesia;

    public function checkingContent(){
        return  DB::table('corporateprofilepages')->where('name', 'operationarea')->first();
     }
    ...
    public function render(){
        return view('livewire.operation-area-component');
    }
}
